...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    choices: [
      { text: '표시를 남긴 사람을 떠올리며 천천히 따라간다', scores: { D2: -2, D6: -1 } },
      { text: '표시의 패턴을 살펴보고 따라갈지 결정한다', scores: { D2: 2, D6: 1 } },
      { text: '일단 따라가보기로 한다', scores: { D2: -1, D6: 2 } },
      { text: '그냥 지나친다', scores: { D2: 1, D6: -2 } },
    ],
  },
  {
    id: 9,
  ...
  // ── Chapter 4 — 숲속의 쉼터 (Q11~Q15) ──
  {
    ...
    choices: [
      { text: '전체적인 분위기를 살핀다', scores: { D1: 1, D2: -1 } },
      { text: '어떤 사람들이 있는지 살펴본다', scores: { D1: 2, D2: 1 } },
      { text: '조용히 한쪽에서 상황을 지켜본다', scores: { D1: -1, D2: -2 } },
      { text: '그냥 지나치거나 따로 행동한다', scores: { D1: -2, D2: 2 } },
    ],
  },
  {
    id: 12,
  ...
  },
  {
    ...
    chapter: 4,
    chapterName: '숲속의 쉼터',
    question: '사람들 사이에서 의견이 갈린다.\n이런 분위기에서는 너는 보통 어떻게 있어?',
    choices: [
      { text: '양쪽 이야기를 모두 들어본다', scores: { D2: -2, D5: -1 } },
      { text: '어느 쪽이 더 맞는지 판단해본다', scores: { D2: 2, D5: 1 } },
      { text: '조용히 흐름을 지켜본다', scores: { D2: -1, D5: -2 } },
      { text: '그 상황에 참여하지 않는다', scores: { D2: 1, D5: 2 } },
    ],
  },
  {
    id: 15,
  ...
  },
  {
    ...
    choices: [
      { text: '일행이 있을 것 같은 방향을 떠올리며 움직인다', scores: { D2: -1, D5: 1 } },
      { text: '왔던 길을 따라 되돌아간다', scores: { D2: -2, D5: -1 } },
      { text: '주변 지형을 보고 방향을 판단한다', scores: { D2: 2, D5: -2 } },
      { text: '일행과 관계없이 내가 정한 방향으로 계속 이동한다', scores: { D2: 1, D5: 2 } },
    ],
  },
  {
    id: 20,
  ...
  },
  {
    ...
    choices: [
      { text: '"이 숲이 다른 누군가에게도 따뜻한 기억이 되었으면 좋겠다."', scores: { D2: -2, D6: -1 } },
      { text: '"누군가가 이 길을 편하게 걸을 수 있으면 좋겠다."', scores: { D2: -1, D6: -2 } },
      { text: '"이 숲을 나답게 기억하고 싶다."', scores: { D6: -1, D1: -1 } },
      { text: '"끝이라기보다 또 다른 시작처럼 느껴진다."', scores: { D4: 1, D6: 1 } },
    ],
  },
];
