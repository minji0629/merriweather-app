...
const DIALOGUES = [
  '안녕. 나는 루야.',
  '나는 메리웨더의 문지기이자, 처음 이곳을 찾아온 사람들을 맞이하는 안내자야.',
  '메리웨더는 바다와 숲이 맞닿은 작은 마을이야.',
  '저마다의 방식으로 살아가는 주민들이 모여 있는 곳이지.',
  '이곳을 탐험하다 보면, 미처 몰랐던 너 자신을 조금씩 알아가게 될 거야.',
  '지금 네가 서 있는 이곳은 기억의 숲이야.',
  '숲은 오래전부터 너를 기다렸어.',
  '나와 함께 걷다 보면, 숲이 너의 이름을 찾아줄 거야.',
  '나랑 같이 가볼래?',
];
